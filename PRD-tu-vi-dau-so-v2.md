...
- [ ] **Xuất PDF searchable / selectable text** (Ghi nhận 11/09/2026, hoãn xử lý): Xuất PDF (Lá số Tử Vi + Hồ sơ Thần Số Học) hiện dùng html2pdf.js dạng ảnh canvas (không tìm-kiếm/copy chữ được). Đã quyết định (Tanh): làm PDF searchable là nâng cấp riêng ở đợt sau, không làm chung với đợt này.
